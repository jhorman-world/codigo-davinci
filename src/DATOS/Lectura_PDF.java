...
public class Lectura_PDF {
    ...
    // 2. pagina2
    /**/
    public ArrayList<Archivos_objeto> leerPDF(String rutaPDF) {
        File file = new File(rutaPDF);
        byte[] bi = null;
        ArrayList<Archivos_objeto> ar = new ArrayList<Archivos_objeto>();
        try {
            ...
            for (int i = 1; i <= numpag; i++) {
                ...
                Archivos_objeto po = new Archivos_objeto();
                po.setIdArchivos(i);
                po.setArchivos(bi);
                ar.add(po);
                //-----
